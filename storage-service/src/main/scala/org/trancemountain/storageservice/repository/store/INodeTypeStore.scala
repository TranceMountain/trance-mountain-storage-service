...
import org.trancemountain.storageservice.repository.nodetype.{INodeTypeDefinition, NodeTypeIdentifier}

/**
	* @author michaelcoddington
	*/
trait INodeTypeStore {
	def createNodeType(yamlString: String): INodeTypeDefinition
	def createNodeTypes(yamlString: String): Set[INodeTypeDefinition]
