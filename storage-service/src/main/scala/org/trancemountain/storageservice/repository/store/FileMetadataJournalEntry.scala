...
object FileMetadataJournalEntry {
	val ACTION_ADD = "ADD"
...
/**
	...
	*/
case class FileMetadataJournalEntry(sessionID: String, filePath: String, hashFilePath: String, revision: RepositoryRevisionNumber, action: String)
